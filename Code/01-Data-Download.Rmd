...
To characterize the study area's climate, we obtained monthly precipitation totals, minimum temperatures, and maximum temperature 30-year normals from PRISM [@prismclimategroup2021] using the *prism* package [@prism2021]. We also obtained gridded June-August SC-PDSI data from the West Wide Drought Tracker [@abatzoglouWestWideDrought2017].
...
We also downloaded actual evaportranspiration (AET) and climatic water deficit (CWD) normals (1981-2010) from Rodman et al. [-@rodman2020DataTraitbasedApproach; -@rodman2020TraitbasedApproachAssessing]. Data is publicly available on Dryad (<https://datadryad.org/stash/dataset/doi:10.5061/dryad.cz8w9gj1b>). For our analyses, we downloaded the zipped data file and stored it in the project subdirectory `r here("Data", "Spatial", "Rodman")`.

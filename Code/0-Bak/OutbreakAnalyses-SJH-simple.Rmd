...
The western spruce budworm (WSB; *Choristoneura occidentalis* Freeman) is one of the most widely distributed native defoliators of coniferous forests in North America, where it plays an important role in shaping forest structure and composition [@johnson1975OutbreaksWesternSpruce; @brookes1987WesternSpruceBudworm]. WSBs are specialist herbivores that preferentially feed upon young buds and new foliage of their host tree species, which include Douglas-fir, true firs (*Abies* spp.) and spruce. Typically, WSBs exist at low population levels and defoliation is minimal [@brookesWesternSpruceBudworm1987]. However outbreaks may occur when several thresholds are crossed and negative feedbacks among the WSB populations, host trees, and natural enemies no longer constrain WSB population dynamics. During outbreaks, populations increase by several magnitudes, causing severe defoliation, reductions in growth, and mortality [@alfaroTreeMortalityRadial1982].

Outbreaks of WSB are most likely to occur in multistoried stands with abundant hosts, particularly when the surrounding landscape is also characterized by abundant hosts [@brookesWesternSpruceBudworm1987; @senfMultiscaleAnalysisWestern2017]. At the stand and landscape scale, patterns of host abundance and size reflect past disturbances and land-use history [@brookes1987WesternSpruceBudworm; @hadleyStandResponseWestern1993]. Across the western United States, forcible displacement of native peoples by Euro-American settlers and the ensuing changes in land management practices, led to important changes in forest composition, structure, and disturbance regimes in some forests [@covington2018HistoricalAnticipatedChanges]. Notably, early Euro-American settlers heavily logged forests near settlements and ignited fires that often burned extensive areas [@veblen1991ColoradoFrontRange]. Both logging practices that emphasize the selective harvesting of large trees and severe wildfires can result reduce host abundance and quality, thereby limiting the susceptibility of stands to outbreaks in the near-term [@hadleyStandResponseWestern1993; @swetnam1993]. While initially logged and burned stands may be less susceptible to WSB outbreaks, after several decades stands may again become susceptible to WSB outbreaks as trees regenerate and grow [@hadleyStandResponseWestern1993; @swetnam1993]. In addition to the effects of logging and wildfires on forests, fire suppression policies and livestock grazing are understood to have increased stand density and the relative abundance of more shade-tolerant species, including Douglas-fir, in many forests characterized by a low-severity, frequent fire regime prior to Euro-American settlement [@covingtonSouthwesternPonderosaForest1994; @veblen2000; @hessburgEnvironmentalNarrativeInland2003]. This increase in stand density and host dominance is may increase stand susceptibility to outbreak. Collectively these changes have been hypothesized to lead to increases in the severity and synchronicity of WSB outbreaks [@swetnam1989]. However evidence for this effect appears to vary regionally, with some studies finding changes in outbreak characteristics following Euro-American settlement in the late 1800s [@swetnam1993; @hadleyStandResponseWestern1993; @flower2014; @ellisMulticenturyDendrochronologicalReconstruction2017], while others have not [@ryersonTreeringReconstructionWestern2003; @alfaroPeriodicityWesternSpruce2014].

Given susceptible stand conditions, WSB outbreaks may be triggered by the direct effects of climate variability on insect populations or the indirect effects as mediated by climate effects on trees. At high elevations and latitudes, warmer spring (March-May) temperatures may prevent WSB mortality that occurs from freezing or destruction of food supplies [@fellinWesternSpruceBudworm1982; @senfMultiscaleAnalysisWestern2017; @regniereInfluenceTemperatureHistoric2019]. However, atypically warm spring temperatures may alter the synchrony of WSB larval emergence and the timing of host tree bud burst, negatively impacting WSB population development rates [@chenMechanismsDouglasfirResistance2001; @nealisPhenologicalWindowWestern2012; @regniereInfluenceTemperatureHistoric2019]. Periods of drought may also influence WSB population dynamics by affecting the quality of host foliage through changes in secondary metabolites and nutrients [@whiteAbundanceInvertebrateHerbivores1984; @mattsonRoleDroughtOutbreaks1987]. Indeed, tree-ring, forest inventory, and geospatial analyses of past outbreaks have most consistently linked outbreak initiation with variation in drought severity [@swetnam1993; @ryersonTreeringReconstructionWestern2003; @flower2014; @senfRemoteSensingForest2017; @xuDroughtMoistureAvailability2019]. However, the effect of drought appears to vary across the geographic distribution of Douglas-fir. At more northern locations (southern British Columbia through southern Idaho), outbreaks have historically followed periods of drought [@flower2014; @axelsonMulticenturyReconstructionWestern2015; @ellisMulticenturyDendrochronologicalReconstruction2017; @harvey2018]. While dendroecological studies at Douglas-fir's drier edge in northern New Mexico and southern Colorado suggest WSB outbreaks occurred following periods of above average moisture availability [@swetnam1989; @ryersonTreeringReconstructionWestern2003]. Collectively these studies suggest that for relatively dry populations of Douglas fir, droughts may limit foliage production and/or decreases foliage palatability, while above average precipitation improves forage quality and quantity for WSBs. Consistent with this expectation, geospatial analyses of outbreak dynamics over the 1997-2015 period, suggest that in the Pacific Northwest, outbreaks generally initiated following drought, while outbreaks in the southwest were more strongly associated with above average moisture availability [@xuDroughtMoistureAvailability2019].

The aim of this paper is to use tree-ring methods to determine the history of western spruce budworm outbreaks from ca. 1700 to 2020 across central to northern Colorado. We use this data to quantify: (1) temporal synchrony in outbreak history, (2) the effects of Euro-American settlement on the dynamics and effects of western spruce budworm outbreaks, and (3) the association between climate and outbreak initiation and cessation.

# Materials and Methods

## Study area

The study area is the upper montane zone (ca. 1700-3300 1500-3000 m) of central to northern Colorado (ca. 38.3° N to 40.8° latitude), where Douglas fir is commonly found (Fig. 1). This region typically experiences warm summers (1991-2020 mean July daily maximum temperature: 25.2 °C), cold winters (1991-2020 mean January daily minimum temperature: -10.3 °C), and moderate amounts of precipitation (1991-2020 mean total annual precipitation: 527 mm) [@prismclimategroup2021]. At local scales, the climate is driven by elevation gradients, the prevailing westerly winds, and the north-south orientation of the mountains. Temperatures are warmer at lower elevations, while more precipitation falls at higher elevations, particularly on the windward side of the Rockies [@lukas2014ClimateChangeColorado]. Summer precipitation patterns exhibit a distinct latitudinal gradient, where more southern locations often receive more precipitation due to the North American Monsoon system [@lukas2014ClimateChangeColorado].

Montane forests across the region are dominated by ponderosa pine (*Pinus ponderosa*) and Douglas fir (*Pseudotsuga menziesii)*, with lesser components of aspen (*Populus tremuloides*), lodgepole pine (*Pinus contorta*), and limber pine (*Pinus flexilis*) [@veblen2005]. Across the study area, we reconstructed periods of western spruce budworm outbreak from 12 sites (Fig. \@ref(fig:FigStudyArea)). Our sites are located on both the eastern and western side of the continental divide.
...
if(!file.exists(here("Data", "prism-JJA.csv"))){
  ...
  prism.JJA <- (prism6.hosts + prism7.hosts + prism8.hosts)/3
  
  prism.JJA %>% write.csv(here("Data", "prism-JJA.csv"),row.names=T)
}
...
To determine if individual trees experienced reductions in growth consistent with defoliation by WSB, we compared the detrended Douglas fir ring width indices with the control time series [@swetnam1985]. Specifically, we calculate the growth suppression index (GSI) using the following equation:

$GSI_{i} =I_{ht} - (SD_{h}/SD_{n})*(I_{nt}-\bar{I}_{n})$

where $I_{ht}$ is the host RWI value for host tree $h$ at year $t$, $SD_{h}$ is the standard deviation of the RWI series for host tree $h$, $SD_{n}$ is the standard deviation of nonhost control series, $I_{nt}$ is the nonhost control series value for year $t$, and $\bar{I}_{n}$ is mean value of the nonhost control series. In the resulting corrected index, values less than one indicate periods of reduced radial growth relative to potential growth. For each tree, we then defined defoliation events when: (1) at least eight consecutive years of below-average growth were detected and (2) at least one year exhibited a reduced growth reduction that was at least 1.28 standard deviations below the mean [@swetnam1985; @harvey2018]. We then defined stand-level periods of outbreak as periods where: (1) at least 40% of the host trees recorded a defoliation event for 4 or more years and (2) the sample depth was greater than 4 trees [@flower2014]. Correction of host tree-ring series and determination of potential WSB defoliation events and outbreak events were performed in R [@rcoreteam2022] using the dfoliatR package [@guiterman2020].
...
#Bridge regional outbreaks so that events seperated by three or more years are considered a single event
j <- 1
...
We extended tree-ring records of WSB outbreak by spatially joining point data describing the location of sample sites with ADS data describing the extent of WSB outbreak by year for the 1996-2021 period. Additionally, we joined sample site location with data describing wildfire extent [@mtbsprojectMTBSDataAccess2022] and the extent of Douglas-fir beetle (*Dendroctonus psuedotsugae*) outbreak, which both lead to mortality of Douglas fir and thereby may be limit the potential for outbreaks to occur. When sites were affected by either Douglas-fir beetle or fire, we truncated the record in the year prior to the disturbance. Finally, we used the composite record to define periods of regionally synchronous outbreak, defined here as two or more consecutive years where at least one third of the sites simultaneously recorded a WSB outbreak. Given not all records extend as far back in time, we limited the regional record to time period where at least 50% of the sites were recording.
...
if(!file.exists(here("Results", "Regional-sychrony.csv"))){
  ...
  Regional.synch <- data.frame(years=c("1730-1998", "1750-1849", "1890-1989"), synchrony=c(Regional.synch.1730.1998, Regional.synch.1750.1849, Regional.synch.1890.1989))
...
Third, we used Multivariate Event Analysis to test for clustering among years of outbreak initiation and cessation. Multivariate Event Analysis is a modification of Ripley's K that identifies the synchrony of events in one dimension (time) within a defined window by comparing the timing of events within multiple records [@gavinWeakClimaticControl2006]. MEA was performed using the R implementation of the software K1D [@gavin2010K1DAnalysisSynchrony].
...
## Quantifying the relationship between climate and outbreaks of the western spruce budworm

To quantify the association between climate variability and WSB outbreak, we used two approaches. First, we used a t-test to determine if SC-PDSI differed during periods of regional outbreak and non-outbreak periods. To quantify SC-PDSI across the region, we averaged SC-PDSI across all sites. Given the assumption of independence of observations and strong serial autocorrelation in the regional SC-PDSI time series, we first fit an autoregressive model to the regional SC-PDSI time series. We used AIC [@akaikeInformationTheoryExtension1973] to select the level of complexity. We fit the model using the R package *stats* [@rcoreteam2022] and then performed the t-test on the residuals.
...
x <- x[x$year>=1750,]
x <- na.omit(x[,c("year", "AVG.resid", "AVG", "outbreak")])
...
p2 <- ggplot(x.early, aes(x=outbreak, y=AVG))+geom_boxplot()+ylab("JJA SC-PDSI")+theme(axis.title.x=element_blank())+geom_text(data=x.early.labs, aes(label = label, x =timeperiod, y = c(6.3,5.9)), size=3)+ylim(-8, 6.5)+theme(axis.title.y=element_blank(), axis.text.y=element_blank())
...
p2+labs(title = "A - 1750-1949")+p3+labs(title = "B - 1750-1949")+plot_layout(nrow=1)
whatever <- dev.off()
...
for(j in host.meta.sub$SeriesCode[!(host.meta.sub$SeriesCode %in% c("B18","WW"))]){
  ...
  pdsi.out.j <- window(pdsi.out.j, start=1750, end=1849)
  pdsi.out.j <-  pdsi.out.j %>% as.data.frame()
  colnames(pdsi.out.j) <- "PDSI"
  row.names(pdsi.out.j) <- 1750:1849
...
jpeg(Fig.file, width=fig.width2, height=5, units="in", res=300)
ggplot(sea.initiation.df.pre, aes(x=lag, y=se.unscaled, fill=sig))+geom_bar(stat="identity")+facet_wrap(.~SeriesCode)+theme(legend.position="bottom", legend.title=element_blank())+scale_fill_manual(values=c("black", "grey30", "lightgray"))+ylab("JJA SC-PDSI anomaly")+xlab("lag (years)")
whatever <- dev.off()

Fig.file <- here("Results", "Figures", "SEA-cessation-site-pre.jpg")
jpeg(Fig.file, width=fig.width2, height=5, units="in", res=300)
ggplot(sea.cessation.df.pre, aes(x=lag, y=se.unscaled, fill=sig))+geom_bar(stat="identity")+facet_wrap(.~SeriesCode)+theme(legend.position="bottom", legend.title=element_blank())+scale_fill_manual(values=c("black", "grey30", "lightgray"))+ylab("JJA SC-PDSI anomaly")+xlab("lag (years)")
whatever <- dev.off()
...
for(j in host.meta.sub$SeriesCode[!(host.meta.sub$SeriesCode %in% c("B18","WW"))]){
  ...
  pdsi.out.j <- ts(pdsi.out[,j], start=min(as.numeric(row.names(pdsi.out))))
  pdsi.out.j <- window(pdsi.out.j, start=1890, end=1989)
  pdsi.out.j <-  pdsi.out.j %>% as.data.frame()
  colnames(pdsi.out.j) <- "PDSI"
  row.names(pdsi.out.j) <- 1890:1989
...
jpeg(Fig.file, width=fig.width2, height=5, units="in", res=300)
ggplot(sea.initiation.df.post, aes(x=lag, y=se.unscaled, fill=sig))+geom_bar(stat="identity")+facet_wrap(.~SeriesCode)+theme(legend.position="bottom", legend.title=element_blank())+scale_fill_manual(values=c("black", "grey30", "lightgray"))+ylab("JJA SC-PDSI anomaly")+xlab("lag (years)")
whatever <- dev.off()

Fig.file <- here("Results", "Figures", "SEA-cessation-site-post.jpg")
jpeg(Fig.file, width=fig.width2, height=5, units="in", res=300)
ggplot(sea.cessation.df.post, aes(x=lag, y=se.unscaled, fill=sig))+geom_bar(stat="identity")+facet_wrap(.~SeriesCode)+theme(legend.position="bottom", legend.title=element_blank())+scale_fill_manual(values=c("black", "grey30", "lightgray"))+ylab("JJA SC-PDSI anomaly")+xlab("lag (years)")
whatever <- dev.off()

sea.initiation.pos.summary.post <- sea.cessation.df.post %>% group_by(lag) %>% summarise(sig05=countpos(sig05),sig10=countpos(sig10),  direction='positive')
...
p1 <- ggplot(sea.initiation.regional, aes(x=lag, y=se.unscaled, fill=sig))+geom_bar(stat="identity")+theme(legend.position="bottom", legend.title=element_blank())+scale_fill_manual(values=c("black","grey30", "lightgrey"),drop=F)+ylab("JJA SC-PDSI anomaly")+xlab("lag (years)")+labs(title = "A - Initiation")

p2 <- ggplot(sea.cessation.regional, aes(x=lag, y=se.unscaled, fill=sig))+geom_bar(stat="identity")+theme(legend.position="bottom", legend.title=element_blank())+scale_fill_manual(values=c("black","grey30", "lightgrey"),drop=F)+ylab("JJA PDSI anomaly")+xlab("lag (years)")+labs(title = "B - Cessation")
...
Here we combined tree-ring and geospatial data to reconstruct periods of WSB outbreak at 12 sites across the Colorado Front Range. Notably our results show that (1) WSB outbreaks occur synchronously across the region, suggestive of a regional driver; (2) ; and( 3) periods of regional outbreak were often initiated by a period of above-average moisture availability that were often proceeded by periods of below-average or average moisture availability. The association between periods of WSB outbreak and high moisture availability supports the plant vigor hypothesis, which suggests that when moisture is generally limiting increases in moisture availability may increase plant growth and thus forage availability [@price1991PlantVigorHypothesis].

## Outbreak histories

We found that periods of regional outbreak occurred from 1761 to 1770, 1792 to 1800, 1833 to 1844, 1890 to 1894, 1897 to 1908, 1920 to 1924, and 1986 to 1990. Notably, all of these periods correspond with periods of outbreak identified in dendroecological studies from Colorado (Table \@ref(tab:historytab)). Further the 1980s outbreak is well documented in observational records from Colorado [@hadleyStandResponseWestern1993; @weber1995DendroecologicalReconstructionWestern] and the 1920s outbreak and is supported by reports from forest entomologists working in northern Idaho and Yellowstone National Park, where observational records of WSB outbreaks began much earlier than in Colorado [@johnson1975OutbreaksWesternSpruce]. This agreement between existing tree-ring and observational records confirms that tree-ring data can provide insights into periods of past WSB outbreak.

Across all our sites the mean outbreak duration (`r host.outbreak.stats.df %>% pull(duration) %>% mean() %>% round(1)` years) and mean length of the quiescent period (`r host.outbreak.stats.df %>% pull(q) %>% mean(na.rm=T) %>% round(1)` years) were similar to those previously reported in dendroecological studies conducted in interior Pacific Northwest [mean duration: 12 years; mean quiescent interval: 15 years; @flower2014], the Colorado Front Range [mean duration: 6.9 years; @weber1995DendroecologicalReconstructionWestern], and southern British Columbia [mean duration: 12 years; mean quiescent interval: 29 years; @campbell2006MulticenturyHistoryWestern]. However, outbreaks in our record were notably shorter and quiescent periods were longer than in dendroecological records from northern New Mexico [mean duration: 22 years; mean quiescent interval: 11 years; @swetnam1993MulticenturyRegionalscalePatterns] and central British Columbia [mean: 18 years; @harvey2018]. These differences likely reflect differences in how the tree-ring data were collected and processed, but also highlight the need for more research that addresses the drivers of outbreak dynamics in space and time, as well as the need for infrastructure for sharing dendroecological data and research that integrates multiple studies.

## Inter-site synchrony

We found that WSB outbreaks occur synchronously across northern to central Colorado, consistent with previous dendroecological research that has identified synchrony across sites in the Interior Pacific Northwest [@flower2014; @ellis2017MulticenturyDendrochronologicalReconstruction]. For population of irruptive insects, temporal synchrony may arise from density-dependent processes (e.g., dispersal, predation) and/or Moran effects [@moran1953StatisticalAnalsisCanadian], where spatial autocorrelation in exogenous drivers, such as climate, leads to synchronicity of density-independent processes [@liebhold2004WithinpopulationSpatialSynchrony]. Here we found that both regional synchrony (`r Regional.synch %>% filter(years=="1730-1998") %>% pull(synchrony) %>% round(2)`) and the spatial scale at which synchrony was statistically significant (50 km) were lower than we would expect if climate was the only driver. For instance, across the 12 drought-sensitive ponderosa pine chronologies used to remove climate-trends in host ring-width series, we calculated greater regional synchrony (```` r summary(sncf.nonhost)$Regional.synch``%>% round(2)``` ```` and significant correlations at larger distances (i.e, up to 100 km; Fig. \@ref(fig:FigCovarianceNonHost)). This supports previous research on spatiotemporal patterns of contemporary WSB outbreak in British Columbia which has suggested that adult moth dispersal is key in driving the synchronization of WBS population dynamics [@senf2017MultiscaleAnalysisWestern]. Nonetheless, our records also show that outbreaks can develop concurrently in disjunct populations. For instance, evidence of the 1790s outbreak appears in the tree-ring record first in ca. 1784 at the TI site, the furthest north and west site in our dataset, and the WR site, which is east of the Continental Divide in the southern Front Range. Budworms are strong fliers that can dispersing hundreds of kilometers in the right weather conditions [@greenbank1980SPRUCEBUDWORMLEPIDOPTERA; @willhite1983GeneticVariationWestern @sturtevant2013LongdistanceDispersalSpruce], thus the coincident development of these disjunct populations may be in part due to dispersal. However, the correspondence between periods of above-average moisture availability and periods of outbreak that we identified here, suggests broad-scale climate variability is important in driving synchronicity in WSB population dynamics. Collectively, these findings confirm previous research that has argued that both dispersal and Moran effects are important in driving the synchrony of local populations of WSBs [@senf2017MultiscaleAnalysisWestern; @flower2014].

## Effects of Euro-American colonization on outbreak dynamics

Our results indicate that at local scale, outbreak duration, frequency, and severity were comparable during the century prior to and following Euro-American colonization, but inter-site synchrony was lower in the 20th century. , disturbed forests have undergone synchronous stand development, setting the stage for the regional outbreak that occurred in the 1980s and ongoing widespread outbreaks [@hadleyStandResponseWestern1993; @swetnam1993].

reducing the potential for dispersal to synchronize population development in[@veblen1991ColoradoFrontRange]. While none of the site examined here experienced severe disturbance in the past century, local WSB population dynamics are sensitive to landscape-level availability of host trees [@senf2017MultiscaleAnalysisWestern]. Thus the decrease in inter-site synchrony and long quiescent period from 1925 to 1980 observed here may reflect landscape-level changes in forest structure and caused by Euro-American settlement practices in the 1860-1890s.

## Climate effects on outbreak dynamics

Across our study area, we found that outbreak initiation occurred during periods of above-average moisture that were proceeded by periods of average of below-average moisture availability. While outbreak cessation occurred when conditions switched from

## Implications and conclusions

Atmosphere-ocean coupled global climate models indicate that droughts will likely become longer and more severe across most of the Western United States over the next century [@gangopadhyay2021WestWideClimateHydrology]. T
...
ft <- set_caption(ft, caption="Summary of modelling results testing the effect of Euro-Americans on western spruce budworm outbreak dynamics and ecological effects .")
ft %>% autofit() %>% fit_to_width(7.5)
```
...
```{r FigSEARegionalTime, fig.cap="Superposed epoch analysis results illustrating the departure from the mean SC-PDSI for the years prior, during, and following years of regional outbreak for the 1730-1998 period and the centuries prior to and following  extensive Euro-American settlement (1750-1848 and 1890-1989, respectively). Red descending bars illustrate the number of sites with a statitcally significant negative association with SC-PDSI (i.e., drier conditions), blue ascending bars show the number of sites with a statistically significant positive association with SC-PDSI (i.e., wetter conditions).", out.width = "7in", results="show"}

knitr::include_graphics(here("Results", "Figures","SEA-Regional-time.jpg"))
```
...
history.tab %>% as.data.frame() %>%  flextable() %>% set_caption(caption="Published periods of western spruce budworm outbreak in Colorado.") %>%  autofit() %>% set_table_properties(layout = "autofit")
```
